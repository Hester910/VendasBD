...
public class BuscarProdutos extends javax.swing.JFrame {
    ...
    private void jTableProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableProdutosMouseClicked
        ...
        for(int i = 0; i < ListProduto.size(); i++){
            if(idProduto == ListProduto.get(i).getCodigo()){
                Produto produto = new Produto();
                produto.setCodigo(ListProduto.get(i).getCodigo());
    ...
    public void preencherTabela() {
        ...
        try {
            dados.clear();
            ListProduto.clear(); //limpa o arrray list
            ListProduto = produtoDao.mostrarProdutos();                     
            for(int i = 0; i < ListProduto.size(); i++){
                
                dados.add(new Object[]{ListProduto.get(i).getCodigo(),ListProduto.get(i).getDescricao(), ListProduto.get(i).getQuantidade(), ListProduto.get(i).getValor()});
